...
The problem of verifying a block belongs in the best source chain has been extensively addressed in the previous chapters. Here, we remark that there are multiple ways of implementing the aforementioned \textsf{in-best-chain} method.
