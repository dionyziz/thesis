\subsection{Smart Contract Construction}
...
\textsf{param}_2,\allowbreak \cdots,\allowbreak \textsf{param}_n)$, the predicate $e$ we wish to check
...
\subsubsection{Cross-chain events}
...
The sidechain smart contracts are presented in Algorithm~\ref{alg.sidechain-pow}.
