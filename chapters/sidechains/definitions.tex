...
%$\LState_i^{\party}[t]$.
\glsxtrnewsymbol[description={set of security assumptions for ledger}]{assum}{$\Assum$}\glsadd{assum}
...
\index{Asset}
\glsxtrnewsymbol[description={abstract asset}]{asset-abstract}{$\Asset$}\glsadd{asset-abstract}
...
\glsxtrnewsymbol[description={image of transaction with no effect}]{_noeffect}{$\noeffect$}\glsadd{_noeffect}
