...
\begin{quotation}
  \noindent
  \textsc{Creative Commons corporation is not a law firm and does
...
\textsc{The work (as defined below) is provided under the terms
...
\textsc{By exercising any rights to the work provided here, you
...
\textbf{2. Fair Dealing Rights.} Nothing in this
...
\textbf{3. License Grant.} Subject to the terms
...
\textbf{4. Restrictions.} The license granted in
...
\textbf{5. Representations, Warranties and
Disclaimer.}
\textsc{Unless otherwise mutually agreed to by the parties in
...
\textbf{6. Limitation on Liability.}
\textsc{Except to
