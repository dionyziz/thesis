...
The way blockchains are structured in order to make this synchronization
efficient is by separating the notion of a \emph{block} from that of a
\emph{block header}. Instead of having each block contain all of its
