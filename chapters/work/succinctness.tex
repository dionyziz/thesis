...
\end{restatable}
\import{./}{chapters/work/proofs/fewlevels.tex}
...
\end{restatable}
\import{./}{chapters/work/proofs/largeexpansion.tex}
...
\begin{restatable}[Small downchain support]{lemma}{restateThmSmallSupport}
    ...
    probability in $m$.
\end{restatable}
\import{./}{chapters/work/proofs/smallsupport.tex}
...
\import{./}{chapters/work/proofs/succinctness.tex}
...
\import{./}{chapters/work/algorithms/alg.badness.tex}
...
% We note that, compared to previous work~\cite{popow}, the adversarial model in
...
\end{restatable}
\import{./}{chapters/work/proofs/infixsuccinctness.tex}
