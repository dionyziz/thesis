...
The safety of a hard fork is debated~\cite{buterinforks}, as they are not
...
\footnote{After the first manuscript of our related paper was published on the
\emph{ePrint} archive, velvet forks were subsequently explored in detail in
the follow-up work by Zamyatin et. al.~\cite{velvet}}.
...
\import{./}{chapters/work/algorithms/alg.nipopow-velvet-upchain.tex}
\import{./}{chapters/work/algorithms/alg.nipopow-velvet-follow.tex}
...
\import{./}{chapters/work/algorithms/alg.nipopow-velvet-prover.tex}

Velvet NIPoPoWs can preserve security if appropriately implemented~\cite{velvet-nipopows}.
% TODO: why?
% TODO: infix for velvet forks are not trivial -- followDown must be redefined
...
\end{restatable}
\import{./}{chapters/work/proofs/velvetsuccinctness.tex}
...
\begin{remark}[Supporting clients with different beliefs]
