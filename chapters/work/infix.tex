...
% TODO: extend this class of predicates to include comparison of position
...
\begin{figure}[h]
    ...
    \centering
    \includegraphics[width=0.7\columnwidth,keepaspectratio]{chapters/work/figures/infix.pdf}
    \label{fig.infix}
\end{figure}

\import{./}{chapters/work/algorithms/alg.nipopow-infix-prover.tex}
...
\import{./}{chapters/work/algorithms/alg.nipopow-infix-follow.tex}
...
\import{./}{chapters/work/algorithms/alg.verifier-infix.tex}
