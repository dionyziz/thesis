...
$\textsf{local-good}_{\delta}(\chain',\allowbreak \chain,\allowbreak \mu)$, if $|\chain'| > (1 -
\delta)2^{-\mu}|\chain|$.
\end{definition}
...
is said to be \emph{good}, written $\textnormal{good}_{\delta, k_1}(\chain,\allowbreak
\chain',\allowbreak \mu)$, with respect to an underlying chain $\chain = \chain'\downchain$
...
probability in $m$.
\end{restatable}
\import{./}{chapters/work/proofs/localgood.tex}
...
$m$.
\end{restatable}
\import{./}{chapters/work/proofs/superquality.tex}
