...
of sidechain security and formally prove our constructions secure.

Our cross-chain certificates allow transmission of generic information
between blockchains. We describe multiple applications,
including proof-of-burn-based one-way pegs and two-way pegs.
In addition to interoperability, our protocols enable transmission of
blockchain information for its own use. This allows the construction of
...
blockchains ERGO, nimiq, WebDollar, Midnight, and Cardano.\\
\end{abstract}
